...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(NamedParamCheckerTests.__allTests__OptionalParamTypeCheckerTests),
        testCase(UnnamedParamTypeCheckerTests.__allTests__RequiredParamTypeCheckerTests),
